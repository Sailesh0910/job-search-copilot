...
def browse_jobs(min_salary=None, work_mode=None, sponsorship_only=False,
                sort_by="newest", limit=50) -> list:
    """Plain structured browsing — filters and sorting, no embedding model needed."""
    return lakebase.browse_jobs(
        min_salary=min_salary, work_mode=work_mode,
        sponsorship_only=sponsorship_only, sort_by=sort_by, limit=limit,
    )
